...
impl BottomPane {
    ...
    /// Compatibility shim for fork-specific chatwidget flow.
    /// Upstream bottom pane does not surface inactive-thread approvals.
    pub fn set_pending_thread_approvals(&mut self, _threads: Vec<String>) {
        self.request_redraw();
    }
