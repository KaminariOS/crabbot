You can find the source code of happy(~/repos/happy) and codex(~/repos/codex) locally. Pull the latest every time you start working. Use the happy and codex codebase as references on demand.
