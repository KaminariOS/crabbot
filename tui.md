...
- [~] Keep upstream bottom pane interactions (composer, slash, overlays, status rows). (composer rendering + key routing now using `BottomPane`; overlays/status rows still partial)
